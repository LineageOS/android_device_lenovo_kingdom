                       ...
                       power_hint_t hint, void *data)
{
    ...
    case POWER_HINT_LOW_POWER:
        ALOGI("POWER_HINT_LOW_POWER: %d", (*(int32_t *)data));
        /* handled by the framework */
        break;

    case POWER_HINT_SUSTAINED_PERFORMANCE: // boost
        ALOGI("POWER_HINT_SUSTAINED_PERFORMANCE: %d",
                (*(int32_t *)data));
    ...
    case POWER_HINT_VR_MODE:
        ALOGI("POWER_HINT_VR_MODE: %d", (*(int32_t *)data));
        break;

    case POWER_HINT_DISABLE_TOUCH:
        ALOGI("POWER_HINT_DISABLE_TOUCH: %d", (*(int32_t *)data));
        break;

    case POWER_HINT_CPU_BOOST:
        ALOGI("POWER_HINT_CPU_BOOST: %dus", (*(int32_t *)data));
        if (!profiles[current_power_profile].boost_allow)
            break;
        boost(true);
        usleep((*(int32_t *)data));
    ...
    case POWER_HINT_SET_PROFILE:
        ALOGI("POWER_HINT_SET_PROFILE: %d", (*(int32_t *)data));
